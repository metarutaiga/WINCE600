...
__DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(char *, __RETURN_POLICY_DST, _CRTIMP, strncat, strncat_s, __inout_z char, __in_z __out_ecount(_Count) char, _Dest, __in_z const char *, _Source, __in size_t, _Count)
